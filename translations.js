const translations = {
  en: {
    ...
    'lang.portuguese': 'Portuguese · Native', 'lang.english': 'English · Advanced',
    'card.sbi.title': 'Senior BI Test', 'card.hashtag.title': 'Hashtag Store', 'card.rauls.title': "Raul's Store", 'card.financial.title': 'Financial', 'card.hr.title': 'HR', 'card.sales.title': 'Sales',
    'astra.pipeline.desc': 'Every question goes through a 4-step pipeline:',
    'astra.step1': 'Natural Language Question', 'astra.step2': 'Claude Haiku classifies intent', 'astra.step3': 'NL → SQL + chart config', 'astra.step4': 'DuckDB executes query', 'astra.step5': 'Claude generates insight',
    'astra.tab.insight.title': 'Insight', 'astra.tab.insight.desc': 'Natural language analysis of the results — trends, peaks, and anomalies highlighted.',
    'astra.tab.chart.title': 'Chart', 'astra.tab.chart.desc': 'Auto-selected chart type (bar, line, pie, horizontal bar) based on the data shape.',
    'astra.tab.sql.title': 'SQL', 'astra.tab.sql.desc': 'The full query that ran, formatted and readable — full transparency on the data source.',
    'astra.tab.raw.title': 'Raw Data', 'astra.tab.raw.desc': 'The underlying dataframe, explorable and filterable in the UI.',
  ...
  pt: {
    ...
    'lang.portuguese': 'Português · Nativo', 'lang.english': 'Inglês · Avançado',
    'card.sbi.title': 'Senior BI Test', 'card.hashtag.title': 'Hashtag Store', 'card.rauls.title': "Raul's Store", 'card.financial.title': 'Financial', 'card.hr.title': 'RH', 'card.sales.title': 'Sales',
    'astra.pipeline.desc': 'Cada pergunta passa por um pipeline de 4 etapas:',
    'astra.step1': 'Pergunta em Linguagem Natural', 'astra.step2': 'Claude Haiku classifica a intenção', 'astra.step3': 'NL → SQL + config do gráfico', 'astra.step4': 'DuckDB executa a consulta', 'astra.step5': 'Claude gera o insight',
    'astra.tab.insight.title': 'Insight', 'astra.tab.insight.desc': 'Análise em linguagem natural dos resultados — tendências, picos e anomalias destacados.',
    'astra.tab.chart.title': 'Gráfico', 'astra.tab.chart.desc': 'Tipo de gráfico selecionado automaticamente (barras, linha, pizza, barras horizontais) com base no formato dos dados.',
    'astra.tab.sql.title': 'SQL', 'astra.tab.sql.desc': 'A consulta completa executada, formatada e legível — transparência total sobre a fonte de dados.',
    'astra.tab.raw.title': 'Dados Brutos', 'astra.tab.raw.desc': 'O dataframe completo, explorável e filtrável na interface.',
